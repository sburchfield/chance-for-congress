...
let policy = [{
                ...
                list: ["Eliminate medical debt", "Work with experts in medical field to find best ways to fix the medical field", "Expand government medical plans to cover all Americans while finding a way to transition away from corporate-backed insurance", "Tackle opioid crisis by improving pharmacy working conditions and expanding access to treatment facilities"]
              },
              {
                title: "War_on_Drugs",
                ...
                list: ["Pass legislation to legalize cannabis country-wide", "Fight to over-turn wrongful convictions relating to drugs", "Introduce legislation to regulate cannabis so that it is safe"]
              },
              {
                title: "Jobs",
              ...
              },
              {
                ...
                list: ["Publish notes on every decision made", "Answer any and all public questions about legislation", "Vote in the best interest of the people", "Work in a bipartisan manner, not only voting along party lines"]
              }
              ]
  ...
  render() {
    ...
    return (
      <div className="container policyHeaderWrapper">
          ...
          <h6 className="page-header">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</h6>
          {cards.map((id, i) => {
            return (
